;;; gunnar-emacs-theme.el --- A dark color theme for Emacs.

;; Copyright (C) 2018-2024 Gunnar Bastkowski

;; Author: Gunnar Bastkowski <gunnar@bastkowski.name>
;; URL: http://github.com/gbastkowski/gunnar-emacs-emacs
;; Version: 1.0.0
...
;; Inspired by IntelliJ's darcula for, built on top of the new built-in theme support in Emacs 24.
